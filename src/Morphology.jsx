  ...
  const stageCanvas=(
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-1 flex-shrink-0 flex-wrap">
        ...
        <button onClick={()=>setIsLooping(!isLooping)} className={`px-2 h-8 rounded-xl font-black text-[8px] tracking-widest border transition-all flex-shrink-0 ${isLooping?'bg-zinc-200 text-black border-zinc-200':'bg-zinc-900 text-zinc-500 border-zinc-800 hover:border-zinc-600'}`}>ARM LOOP {isLooping?'●':'○'}</button>
